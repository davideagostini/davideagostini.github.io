...
declare module 'astro:content' {
	...
	type ContentEntryMap = {
		"blog": {
"build-a-web-app-with-flutter-and-deploy-it-to-firebase-hosting.md": {
	id: "build-a-web-app-with-flutter-and-deploy-it-to-firebase-hosting.md";
  slug: "build-a-web-app-with-flutter-and-deploy-it-to-firebase-hosting";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
"build-the-famous-tic-tac-toe-game-in-flutter.md": {
	id: "build-the-famous-tic-tac-toe-game-in-flutter.md";
  slug: "build-the-famous-tic-tac-toe-game-in-flutter";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
"building-beautiful-ui-in-flutter.md": {
	id: "building-beautiful-ui-in-flutter.md";
  slug: "building-beautiful-ui-in-flutter";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
"can-anyone-become-a-software-developer.md": {
	id: "can-anyone-become-a-software-developer.md";
...
"draw-a-circular-control-with-custompainter-in-flutter.md": {
	id: "draw-a-circular-control-with-custompainter-in-flutter.md";
  slug: "draw-a-circular-control-with-custompainter-in-flutter";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
"find-the-non-duplicate-number-in-an-array.md": {
	id: "find-the-non-duplicate-number-in-an-array.md";
  slug: "find-the-non-duplicate-number-in-an-array";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
"how-to-create-a-beautiful-hover-effect-on-a-card-in-flutter.md": {
	id: "how-to-create-a-beautiful-hover-effect-on-a-card-in-flutter.md";
